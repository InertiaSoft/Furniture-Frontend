      ...
      <Layout>
        <div className="min-h-screen">
          ...
          <div className="bg-white">
            <div className="mx-auto py-5 max-w-full px-3 sm:px-10">
              ...
              <div className="bg-orange-100 px-10 py-6 rounded-lg mt-6 hidden lg:block text-custom-grey">
                <Banner />
              </div>
            </div>
          </div>
          ...
          {/* feature category's */}
          <div className="text-custom-white  lg:py-16 py-10">
